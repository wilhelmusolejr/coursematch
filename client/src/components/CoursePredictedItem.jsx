...
export default function CoursePredictedItem({
  ...
  let classname, heading, tagline, model;
  ...
  return (
    <div
      className={`rounded-lg border-1 border-black/10  max-w-100 xl:flex-1 ${classname}`}
    >
      ...
      <div className="text-center mt-10 py-5 bg-blue-primary text-white rounded-b-lg  border-1 border-black/10">
        <p className="font-semibold tracking-wide uppercase text-lg">
          Model {model}
        </p>
      </div>
    </div>
